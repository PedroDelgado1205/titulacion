document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveDrawing').addEventListener('click', () => {
        ...
        fetch('/dibujo/guardar_edicion_dibujo/', {
            method: 'POST',
            headers: {
    ...
    function loadExistingImage() {
        ...
        image.onload = () => {
            ...
            newWidth = (newCanvas.width * scale)/2.4;
            newHeight = (newCanvas.height * scale)/2.4;
    
            context.drawImage(image, 20, 15, newWidth, newHeight);
